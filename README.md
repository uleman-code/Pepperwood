...
1. Download the zip file from https://github.com/uleman-code/Pepperwood/archive/refs/heads/main.zip
    ...
    - Unzip in directory of your choice
        - This creates …\your_directory\Pepperwood-main with files and a subdirectory.
    - Open a command window (or powershell)
        - Change directory to …\Pepperwood-main
        - Create a virtual environment (PS = PowerShell)
            C:\> python -m venv .
            PS c:\> Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Scope CurrentUser
        - Activate the virtual environment (use one or the other, CMD or PowerShell)
            - NOTE: need to verify the path to the virtual environment! Should be .venv if still in the installation root directory.
